...
if(isset($_GET['daterange']) && $_GET['daterange'] != ""){
    ...
    $agentData = new Details($selectedUsergroup, $dateRange[0],$dateRange[1]);
    $agentData -> listData();
    $showTable = true;
                        ...
                        <div class="form-wrap">
                            <form action="" method="GET">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="usergroup[]" class="selectpicker" multiple data-style="form-control btn-default btn-outline" required>
                                        <?php
